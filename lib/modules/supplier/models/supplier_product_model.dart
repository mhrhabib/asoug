class SupplierProductModel {
  List<SupplierProduct>? data;
  Links? links;
  Meta? meta;

  SupplierProductModel({this.data, this.links, this.meta});

  SupplierProductModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = <SupplierProduct>[];
      json['data'].forEach((v) {
        data!.add(SupplierProduct.fromJson(v));
      });
    }
...
class SupplierProduct {
  ...
  SupplierProduct({this.id, this.name, this.hasBulkDiscount, this.minPrice, this.maxPrice, this.rating, this.featuredImage, this.slug});
